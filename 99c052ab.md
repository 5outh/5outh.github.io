...
wrappers and avoid [[0aad2e98]]. This is a pretty common idiom, and it helps a bit:
...
special cases like filters and sorting. It reminds me of [[24e8a789]] in
...
## Utilizing [[0b7171c6]]s and [[1b112336]]s

`fetchPostArgs` looks a lot like a [[0b7171c6]], and we can certainly frame it
...
with this formulation, we can build up [[1b112336]]s and compose them to
...
(User 1) liked**. Some [[1b112336]]s can help here:
...
Using [[0b7171c6]]s gives us better composition of common operations in many
